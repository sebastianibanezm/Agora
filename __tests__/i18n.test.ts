...
describe('i18n', () => {
  ...
  it('es and en have identical key shapes', () => {
    const shape = (o: unknown): unknown => Array.isArray(o) ? '[]' : (o && typeof o === 'object' ? Object.fromEntries(Object.keys(o as object).sort().map(k => [k, shape((o as Record<string,unknown>)[k])])) : '_');
